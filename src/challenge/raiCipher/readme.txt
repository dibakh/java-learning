...
Test Cases:
Input:"Hello, World!" Output:"Hoo!el,Wrdl l"  with number of rails=3
Input:"Hello, World!" Output:"H !e,Wdloollr"  with number of rails=4
Be careful about space in the string!!!!
